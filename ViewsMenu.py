...
class ViewsMenu(QWidget):
    def __init__(self, info: str):
        ...
        self.erosion = QPushButton("Adapt your picture of the stars")
        self.LayoutActions.addWidget(self.title, alignment=Qt.AlignmentFlag.AlignCenter)
        self.LayoutActions.addWidget(self.erosion, alignment=Qt.AlignmentFlag.AlignCenter)

        # Layout of the informations
        self.LayoutInformation = QHBoxLayout()
        informations = QLabel(info)
        informations_font = QFont("Segoe UI", 15)
        informations.setFont(informations_font)
        informations.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.LayoutInformation.addWidget(informations)
