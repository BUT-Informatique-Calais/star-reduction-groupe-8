...
from ViewsMenu import ViewsMenu
from ViewsResults import ViewsResults
...
class Controller():
    def __init__(self):
        ...
        # informations
        informations : str = "Armand Cuvelier - Nolan Vannorenberghe - Jordan Sow - Version 1 - developed on 09/01/2026"
        
        # Initialisations of the views
        self.ViewsResults = ViewsResults(informations)
        self.ViewsResults.setWindowTitle("SAE")
        self.ViewsMenu = ViewsMenu(informations)
        self.ViewsResults.setWindowTitle("SAE")
        
        #Initialisation of the signals of the views menu
        self.ViewsMenu.erosion.clicked.connect(lambda : self.erosion())
        
        #Initialisation of the signals of the views results
        self.ViewsResults.exit.clicked.connect(QApplication.quit)
    ...
    def results(self): 
        ...
        # Add picture of the results
        results = QLabel()
        pixmap = QPixmap("results/final.png")
        results.setPixmap(pixmap)
        self.ViewsResults.LayoutPicture.addWidget(results, alignment=Qt.AlignmentFlag.AlignCenter)
        
        # Put the good views
        self.ViewsResults.show()
